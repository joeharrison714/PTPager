metadata {
    ...
    preferences {
        input("DeviceAddress", "string", title:"PTPager IP Address", description:"IP address of the machine running PTPager", defaultValue:"" , required: false, displayDuringSetup: true)
        input("DevicePort", "string", title:"PTPager Port", description:"Port of the machine running PTPager", defaultValue:"5666", required: false, displayDuringSetup: true)
    }
    tiles {
